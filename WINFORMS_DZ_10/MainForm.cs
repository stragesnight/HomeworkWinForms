...
namespace WINFORMS_DZ_10
{
    public partial class MainForm : Form
    {
        ...
        {
            this.Text = "ДЗ №10, Шелест";
            textBox1.ScrollBars = ScrollBars.Both;

            MessageBox.Show("ДЗ №10, Шелест\n"
                + "Интеграция функции печати в текстовый редактор из ДЗ №7\n"
                + "Кнопка печати добавлена в верхнюю сроку меню.");
        }
