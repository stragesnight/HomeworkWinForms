...
namespace WINFORMS_DZ_02
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label6.Text = "Введите дату своего рождения в полях ниже,\r\nи она отобразится на календаре.\r\nЕсли" +
    " данные в полях некорректны, календарь\r\nвосстанавливается к текущей дате.";
            // 
            // Form1
            // 
